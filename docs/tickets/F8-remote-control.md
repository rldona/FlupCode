...
## F8-2 — Secure channel (`@flupcode/remote`) · P0 · todo
...
## F8-3 — Tunnel multiplexer (`@flupcode/remote`) · P0 · todo
...
## F8-4 — Relay server (`@flupcode/relay`) · P0 · todo
...
## F8-6 — Harness transport · P0 · todo
...
## F8-7 — Remote control UI · P0 · todo
...
## F8-8 — Docs and end-to-end test · P1 · todo

**Acceptance**
- USAGE and ARCHITECTURE updated; relay deployment documented.
- Automated test: relay + host + tunnel client against a fake engine.
