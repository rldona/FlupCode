...
8. Publica: `publish-isobaria({ text, template: <la plantilla del mapa o "card">, location: <slug>, alt })`. Si responde `UNSUPPORTED_PHENOMENON`, reescribe y vuelve al paso 6; si vuelve a caer, dilo y para.
