 ...
 */
export type Screen = "routines" | "runs" | "artifacts" | "changes" | "usage" | "context" | "agents"

const SCREENS: readonly Screen[] = ["routines", "runs", "artifacts", "changes", "usage", "context", "agents"]
