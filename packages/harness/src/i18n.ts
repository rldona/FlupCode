...
const ES: Record<string, string> = {
  ...
  "Wait for the session to finish compacting": "Espera a que la sesión termine de compactarse",
  ...
  "Reload engine": "Recargar motor",
  "Click again to reload": "Pulsa otra vez para recargar",
  ...
  "Reloading rereads the engine's configuration, so new or edited agents and skills take effect. It drops the turns in flight.":
    "Recargar relee la configuración del motor, así que los agentes y skills nuevos o editados surten efecto. Descarta los turnos en curso.",
  "Engine reloaded": "Motor recargado",
  "Could not reload the engine": "No se pudo recargar el motor",
  Usage: "Uso",
  "Clear completed": "Borrar completadas",
  "Clear all": "Borrar todo",
  "Clear completed subagents": "Borrar subagentes completados",
  "Clear all subagents": "Borrar todos los subagentes",
  ...
  "Configure an OpenAI-compatible provider. See the ": "Configurar un proveedor compatible con OpenAI. Ver la ",
  "provider config docs": "documentación de configuración del proveedor",
  "Provider ID": "ID del proveedor",
  myprovider: "miproveedor",
  "Lowercase letters, numbers, hyphens, or underscores": "Letras minúsculas, números, guiones o guiones bajos",
  "Display name": "Nombre para mostrar",
  "My AI Provider": "Mi Proveedor de IA",
  "Base URL": "URL base",
  "https://api.myprovider.com/v1": "https://api.miproveedor.com/v1",
  ...
  "Use lowercase words separated by commas": "Usa palabras en minúscula separadas por comas",
  "Optional. Comma-separated reasoning effort levels.": "Opcional. Niveles de esfuerzo separados por comas.",
  "Headers (optional)": "Encabezados (opcional)",
  Header: "Encabezado",
  "Header-Name": "Nombre-Encabezado",
  Value: "Valor",
  value: "valor",
  "Remove header": "Eliminar encabezado",
  "Add header": "Añadir encabezado",
  "Provider ID is required": "El ID del proveedor es obligatorio",
  "Use lowercase letters, numbers, hyphens, or underscores":
    "Usa letras minúsculas, números, guiones o guiones bajos",
  "That provider ID already exists": "Ese ID de proveedor ya existe",
  "Display name is required": "El nombre para mostrar es obligatorio",
  "Base URL is required": "La URL base es obligatoria",
  "Must start with http:// or https://": "Debe comenzar con http:// o https://",
