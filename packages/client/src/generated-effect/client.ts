...
type Endpoint12_0Request = Parameters<RawClient["server.memory"]["memory.list"]>[0]
type Endpoint12_0Input = {
  readonly location?: Endpoint12_0Request["query"]["location"]
  readonly text?: Endpoint12_0Request["query"]["text"]
  readonly scope?: Endpoint12_0Request["query"]["scope"]
  readonly status?: Endpoint12_0Request["query"]["status"]
  readonly sessionID?: Endpoint12_0Request["query"]["sessionID"]
  readonly agent?: Endpoint12_0Request["query"]["agent"]
  readonly limit?: Endpoint12_0Request["query"]["limit"]
}
const Endpoint12_0 = (raw: RawClient["server.memory"]) => (input?: Endpoint12_0Input) =>
  raw["memory.list"]({
    query: {
...
type Endpoint12_1Request = Parameters<RawClient["server.memory"]["memory.get"]>[0]
type Endpoint12_1Input = { readonly id: Endpoint12_1Request["params"]["id"] }
const Endpoint12_1 = (raw: RawClient["server.memory"]) => (input: Endpoint12_1Input) =>
  raw["memory.get"]({ params: { id: input["id"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint12_2Request = Parameters<RawClient["server.memory"]["memory.create"]>[0]
type Endpoint12_2Input = {
  readonly scope?: Endpoint12_2Request["payload"]["scope"]
  readonly kind?: Endpoint12_2Request["payload"]["kind"]
  readonly title: Endpoint12_2Request["payload"]["title"]
  readonly content: Endpoint12_2Request["payload"]["content"]
  readonly tags?: Endpoint12_2Request["payload"]["tags"]
  readonly status?: Endpoint12_2Request["payload"]["status"]
  readonly confidence?: Endpoint12_2Request["payload"]["confidence"]
  readonly importance?: Endpoint12_2Request["payload"]["importance"]
  readonly source?: Endpoint12_2Request["payload"]["source"]
  readonly sessionID?: Endpoint12_2Request["payload"]["sessionID"]
...
type Endpoint12_3Request = Parameters<RawClient["server.memory"]["memory.update"]>[0]
type Endpoint12_3Input = {
  readonly id: Endpoint12_3Request["params"]["id"]
  readonly title?: Endpoint12_3Request["payload"]["title"]
  readonly content?: Endpoint12_3Request["payload"]["content"]
  readonly kind?: Endpoint12_3Request["payload"]["kind"]
  readonly tags?: Endpoint12_3Request["payload"]["tags"]
  readonly status?: Endpoint12_3Request["payload"]["status"]
  readonly confidence?: Endpoint12_3Request["payload"]["confidence"]
  readonly importance?: Endpoint12_3Request["payload"]["importance"]
}
...
type Endpoint12_4Request = Parameters<RawClient["server.memory"]["memory.remove"]>[0]
...
const Endpoint12_4 = (raw: RawClient["server.memory"]) => (input: Endpoint12_4Input) =>
  raw["memory.remove"]({ params: { id: input["id"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint12_5Request = Parameters<RawClient["server.memory"]["memory.verify"]>[0]
type Endpoint12_5Input = { readonly id: Endpoint12_5Request["params"]["id"] }
const Endpoint12_5 = (raw: RawClient["server.memory"]) => (input: Endpoint12_5Input) =>
  raw["memory.verify"]({ params: { id: input["id"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint12_6Request = Parameters<RawClient["server.memory"]["memory.used"]>[0]
type Endpoint12_6Input = { readonly sessionID: Endpoint12_6Request["params"]["sessionID"] }
const Endpoint12_6 = (raw: RawClient["server.memory"]) => (input: Endpoint12_6Input) =>
  raw["memory.used"]({ params: { sessionID: input["sessionID"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup12 = (raw: RawClient["server.memory"]) => ({
  list: Endpoint12_0(raw),
  get: Endpoint12_1(raw),
  create: Endpoint12_2(raw),
  update: Endpoint12_3(raw),
  remove: Endpoint12_4(raw),
  verify: Endpoint12_5(raw),
  used: Endpoint12_6(raw),
})
